...
//}
//
//void viewAndEdit(sf::RenderWindow& window, int WINDOW_WIDTH, int WINDOW_HEIGHT, int xMoved, int yMoved, int language, int scrool, int sideScrool, int sidePress, int PozMx, int PozMy, std::string Name, bool& figureChosed, bool changeUp, bool changeDown, int cpozx, int cpozy, bool movingScreen)
//{
//	sf::Font font;
//	if (!font.loadFromFile("Fonts/calibri.ttf"));
//
...
//
//		a.figures(window, WINDOW_WIDTH, WINDOW_HEIGHT, size.x, size.y, xMoved, yMoved, language);
//		a.componentsNames(window, WINDOW_WIDTH, WINDOW_HEIGHT,Name, PozMx, PozMy, changeUp, changeDown, cPozX, cPozY);
//
//
...
//		a.componentsDrawMoving(window, WINDOW_WIDTH, WINDOW_HEIGHT, Name, "");
//	}
//	window.display();
//}
//
//void interfata(sf::RenderWindow& window, int WINDOW_WIDTH, int WINDOW_HEIGHT)
//{
...
//			else
//				viewAndEdit(window, WINDOW_WIDTH, WINDOW_HEIGHT, pozMx, pozMy, language, down, right, sidePress, pozX, pozY, saveNameOfProject, figureChosed, changeUp, changeDown, cPozX, cPozY, moving);
//
//		}
//	}
//}