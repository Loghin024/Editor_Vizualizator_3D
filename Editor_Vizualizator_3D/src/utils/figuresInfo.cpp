...
//
//
//void figuresInfo::figures(sf::RenderWindow& window, int WINDOW_WIDTH, int WINDOW_HEIGHT,int height, int width, int PozMx, int PozMy, int language)
//{
//	using namespace sf;
//	char figure[100];
...
//}
//
//void figuresInfo::componentsNames(sf::RenderWindow& window, int WINDOW_WIDTH, int WINDOW_HEIGHT, std::string Name, int pozMx, int pozMy, bool changeUp, bool changeDown, int x, int y)
//{
//	using namespace sf;
//	using namespace std;
//	int line = 0;
...
//				componentsDrawStatic(window, WINDOW_WIDTH, WINDOW_HEIGHT, Name, sir);
//
...
//}
//
//void figuresInfo::componentsDrawStatic(sf::RenderWindow& window, int WINDOW_WIDTH, int WINDOW_HEIGHT, std::string Name, std::string componentName)
//{
...
//}
//
//void figuresInfo::componentsDrawMoving(sf::RenderWindow& window, int WINDOW_WIDTH, int WINDOW_HEIGHT, std::string Name, std::string componentName)
//{
